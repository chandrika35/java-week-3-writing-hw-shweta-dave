 ...
 * English marks(mark is between0 to 100 and if it is out of range print error message "Invalid
 * Input, Marks should between0 to 100") ads find out total,percentage and result.
